...
def main(args):
    ...
    ground_truth = []
    predicted = []
    for _, (images, captions) in enumerate(data_loader):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='./trained_models/encoder-8-434.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='./trained_models/decoder-8-434.ckpt', help='path for trained decoder')
    ...
    parser.add_argument('--val_path', type=str, default='./dataset/Flickr_8k.devImages.txt', help='path for val split file')
